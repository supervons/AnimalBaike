	...
	<body>
		<section id="container" class="">
			...
			<header class="header dark-bg text-center">
				<h1>即时PK<small>---谁高谁低，一目了然!</small></h1>
			</header>
							...
							<div class="center-block">
								...
								<table class="table table-bordered col-sm-8" style="font-size: 25px;">
									...
									<input type="hidden" name="voteId" value="tempPK"  class="form-control">
										<tr>
											<td  colspan="2" class="text-center ">${tempPk.voteTitle}</td>
										</tr>										
										<tr  style="background-color: red;">
											<td class="text-center " style="background-color: red;color: black;">${tempPk.voteResultA}</td>
											<td class="text-center " style="background-color: blue;color: white;">${tempPk.voteResultB}</td>
										</tr>
										<tr style="background-color: blue;"  >
											<td class="text-center "style="background-color: red;color: black;">${redCount}</td>
											<td class="text-center "style="background-color: blue;color: white;">${blueCount} </td>
										</tr>
