								...
								<table class="table table-bordered col-sm-8">
									<thead>
										<tr>
											...
											<td><input type="text" name="voteId" class="form-control">${addVoteFlag}</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" name="voteExplain" class="form-control" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" name="voteResultC" class="form-control"></td>
										</tr>
										<tr>
											<th class="text-right ">选择4：</th>
											<td><input type="text" name="voteResultD" class="form-control"></td>
										</tr>
										<tr>
											<th class="text-right">开始时间：</th>
											<td><input type="text" name="voteBeginTime" class="form-control" onclick="fPopCalendar(event,this,this)" readonly="readonly"/></td>
										</tr>
										<tr>
											<th class="text-right">截止时间：</th>
											<td><input type="text" name="voteEndTime" class="form-control" onclick="fPopCalendar(event,this,this)" readonly="readonly"/></td>
										</tr>
									</thead>
									<tbody>
										<tr>
