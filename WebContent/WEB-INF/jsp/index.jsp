		...
		<div class="container">
			<nav class="navbar navbar-inverse" role="navigation">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand scroll-top logo"><b>动物百科</b>AnimalBK</a>
				</div>
				<!--/.navbar-header-->
				<div id="main-nav" class="collapse navbar-collapse">
					<ul class="nav navbar-nav" id="mainNav">
						...
						<li><a href="#services" class="scroll-link">发现动物</a></li>
						<li><a href="#portfolio" class="scroll-link">分享动物</a></li>
						<li><a href="#team" class="scroll-link">论坛</a></li>
						<li><a href="#contactNature" class="scroll-link">亲近自然</a></li>
						<li><a href="#contactUs" class="scroll-link">搜索排行</a></li>
						<li><a href="login.jsp" class="scroll-link">登陆</a></li>
					</ul>
				</div>
				<!--/.navbar-collapse-->
			</nav>
